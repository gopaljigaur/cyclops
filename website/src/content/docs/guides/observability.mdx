...
`OTelHooks.console()` sets up a `TracerProvider` and `ConsoleSpanExporter` automatically — no boilerplate required. Spans are flushed automatically at the end of each run.
